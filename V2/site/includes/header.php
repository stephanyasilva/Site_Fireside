            ...
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item dropdown px-5 text-center">
                    ...
                    <ul class="dropdown-menu custom-dropdown">
                        <li><a class="dropdown-item" href="#">Sistema de alarme de incêndio</a></li>
                        <li><a class="dropdown-item" href="#">Pressurização de Escada</a></li>
                        <li><a class="dropdown-item" href="#">Manutenção em sistemas de alarme</a></li>
                        <li><a class="dropdown-item" href="#">Assessoria AVCB/CLCB</a></li>
                        <li><a class="dropdown-item" href="#">Sistema de Sprinkler</a></li>
